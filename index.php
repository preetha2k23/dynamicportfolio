...
<head>
        ...
        <title>preetha - Personal Portfolio HTML5 Template</title>
        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <!--<a href="index.php" class="navbar-brand s-logo-none"><img src="front_end_assets/img/logo/vp logo.png" alt="Logo"></a>-->
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#service">projects and service</a></li>
            ...
            <div class="extra-info">
                ...
                <div class="logo-side mb-30">
                    <a href="index-2.html">
                        <img src="front_end_assets/img/logo/ vp logo.png" alt="" />
                    </a>
                </div>
                              ...
                              <?php foreach($testimonial_query as $row){ ?>
                                ...
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img style="width:100px;height: 100px;border-radius: 50%;" src="admin/image/customers/<?=$row['photo']?>" alt="">
                                    </div>
               ...
               <!-- contact information query in side view part -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="contact-content">
                                ...
                                <h5>FROM : <span><?=$contact_information['office']?></span></h5>
